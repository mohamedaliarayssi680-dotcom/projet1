  ...
  return (
    ...
    >
      ...
      <div className="relative loader-container">
        ...
        <div
          className={`absolute ${currentSize.orbit} -inset-4 loader-ring-outer`}
        >
          <div
            className={`w-full h-full border-2 border-dashed rounded-full ${isDarkMode ? "opacity-40" : "opacity-30"}`}
            style={{ borderColor: currentColors.primary }}
          />
        </div>

        <div
          className={`absolute ${currentSize.orbit} -inset-2 loader-ring-middle`}
        >
          <div
            className={`w-full h-full border border-dotted rounded-full ${isDarkMode ? "opacity-60" : "opacity-50"}`}
        ...
        <div className={`relative ${currentSize.main} loader-morph`}>
          ...
          <div className="absolute inset-0">
            <div
              className="loader-wave-1 absolute inset-0 rounded-full"
              style={{
                background: `radial-gradient(circle, ${currentColors.glow} 0%, transparent 60%)`,
              }}
            />
            <div
              className="loader-wave-2 absolute inset-0 rounded-full"
              style={{
                background: `radial-gradient(circle, ${currentColors.glow} 0%, transparent 60%)`,
              }}
            />
      ...
      {text && (
        <div className="mt-8 text-center">
          <div className="relative mb-4">
            <span
              className={`${isDarkMode ? "text-2xl" : "text-xl"} font-semibold loader-text-main`}
              style={{
